<?php
include 'Backend/register.inc.php';
?>
<!doctype html>
...
<body>
    ...
    <div class="register">
        ...
        <form action="" method="POST" id="form">
            ...
            <input type="text" name="fname" id="fiName" placeholder="Enter First Name"><br><br>

            <label>Last Name</label><br>
            <input type="text" name="lname" id="laname" placeholder="Enter Last Name"><br><br>
            ...
            <input type="email" name="email" id="email2" placeholder="Enter Your Email"><br><br>

            <label>Nationality</label><br>
            <input type="text" name="nationality" id="nation" placeholder="Enter Your Nationality"><br><br>

            <label>Residential Address</label><br>
            <input type="text" name="address" id="readdress" placeholder="Enter Your Residental Address"> <br><br>

            <label>Mobile Number</label><br>
            <input type="text" name="mnumber" id="mobinumber" placeholder="Enter Your Mobile Number"><br><br>
            ...
            <div class="check">
                <input type="checkbox" name="checkb"> I accept the <a href="Terms.html">Terms & Conditions</a>
            </div>


            <input type="submit" value="Submit" id="sub2" onclick="myfunction()" name="signup">
