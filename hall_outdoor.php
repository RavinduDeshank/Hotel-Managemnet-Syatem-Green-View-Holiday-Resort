            ...
            <div class="container">
				<div class="row justify-content-center">
					<div class="col-xl-8">
						...
						<div class="font-back-tittle mb-50">
							...
							<h3 class="archivment-back">Outdoor Area</h3>
						</div>
					</div>
                </div>
                <br>
                ...
                <div class="all">
                    <div class="row">
                        <div class="column">
                            <div class="feature">
                                ...
                                <ul class="points">
                                    ...
                                    <li>- Table for registation (For weddings)</li>
                                    <li>- Fresh juice as welcome dirink</li>
                                    <li>- Day-use room and overnight stay for the bridal couple</li>
                                    <li>- Special lightning system</li>
                                    <br>
                        ...
                        <div class="column">
                            <img src="assets/img/halls/outdoor_party.jpg">
                        </div>
                    </div>
                </div>
                <br>
