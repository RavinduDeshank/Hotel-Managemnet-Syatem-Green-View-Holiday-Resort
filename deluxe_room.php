                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo">
                               <a href="index.html"><img src="assets/img/logo/logo-img.png" alt=""></a>
                            </div>
                        </div>
				...
				<div class="row justify-content-center">
					<div class="col-xl-8">
						...
						<div class="font-back-tittle mb-50">
							...
							<h3 class="archivment-back">Deluxe Room</h3>
						</div>
					</div>
                </div>
                <div class="all">
                    <div class="row">
                        <div class="column">
                            <div class="feature">
                                <br>
                                <h2 class="hedding"><center>AMENITIES</center></h2>
                                <br>
                                <ul class="points"><br>
                                    <li>- King-sized bed</li><br>
                                    <li>- Air-Conditioning</li><br>
                                    <li>- Hot and Cool water</li><br>
                                    <li>- Complimentary Wi-Fi</li><br>
                                    <li>- LED TV</li><br>
                                    <li>- Tea and Coffee maker</li><br>
                                    <br>
                                </ul>
                                <div>
                        ...
                        <div class="column">
                            <img ; src="assets/img/rooms/Deluxe-Sea-View-With-Private-Balcony_03-1000x667.jpg" width="100%" height="100%">
                        </div>
                    </div>
                    </div>
                <br>
                ...
                <div class="row">
					...
					<div class="col-xl-4 col-lg-6 col-md-6">
						<div class="single-blog mb-50">
							<div class="blog-img">
                                <img src="assets/img/rooms/Deluxe_Sea_View_With_Private_Balcony_Bathroom-1000x667.jpg" style="width:100%"></a>
					...
					<div class="col-xl-4 col-lg-6 col-md-6">
						<div class="single-blog mb-50">
							<div class="blog-img">
								<img src="assets/img/rooms/Deluxe-Sea-View-With-Private-Balcony_01-1000x667.jpg" style="width:100%"></a>
							</div>
						</div>
					</div>
					<!--Outdoor Area-->
					<div class="col-xl-4 col-lg-6 col-md-6">
						<div class="single-blog mb-50">
							<div class="blog-img">
								<img src="assets/img/rooms/Deluxe-Sea-View-With-Private-Balcony_02-1000x667.jpg" style="width:100%"></a>
							</div>
						</div>
					</div>
				</div>
