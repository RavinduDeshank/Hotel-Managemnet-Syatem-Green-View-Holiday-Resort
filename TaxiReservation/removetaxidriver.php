...
<<<<<<< HEAD
=======
/*geeting taxi driver information*/
>>>>>>> 77b7c97d6aa58937a901cee9a1114492dbbe1212
$sql = "SELECT * FROM taxidriver WHERE user_type='taxiDriver'";
...
<body>
    ...
    <div id="box5">
        <center>
        <h3 class="title1 mt-2"> <u>REMOVE TAXI DRIVERS</u> </h3>
        </center>
        ...
        <table id="removepromotable" class="mt-5">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="Backend/removetaxidri.inc.php?id=<?php echo $id ?>"><button onclick="myFunction()"> Remove </button></a></td>
                <?php
            }
                ?>
        </table>
        ...
        <a href="taxidrivermngment.php"><button type="button" value="Back" id="bbutton2"> Back</button></a>
    ...
    <script>
        ...
        function myFunction() {
            alert("Taxi Driver removed successfully");
        }
    </script>
    <br>
    <br>
