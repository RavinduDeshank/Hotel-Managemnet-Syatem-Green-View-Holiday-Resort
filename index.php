...
>>>>>>> c68b2bfc1a11fe1302bdfcbf5e234fa0daeb0537
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">Welcome to </h1>
                                    <h3 data-animation="fadeInDown" data-delay=".4s">Green View Holiday Resort</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="col-xl-5 col-lg-6">
                        <div class="customer-img mb-120">
                            ...
                            <div class="service-experience heartbeat">
                                <h3>10 Years of Service<br>Experience</h3>
                            </div>
                        </div>
                   </div>
