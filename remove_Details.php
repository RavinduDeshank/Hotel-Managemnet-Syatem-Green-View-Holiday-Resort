...
<head>
    ...
    <title>Green View Holiday Resort | Remove Laundry Details</title>
...
<body>
    ...
    <br>
    <div id="box5">
        <h3 class="title1"> <u style="color: white;">REMOVE DETAILS</u> </h3>
        ...
        <table id="removepromotable" style="margin-top: 50px;">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="Backend/deletelaundrydetails.inc.php?id=<?php echo $id ?>"><button onclick="myfunction()"> Remove </button></td></a>
                </tr>
