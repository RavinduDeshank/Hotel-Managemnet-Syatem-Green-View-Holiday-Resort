...
<main>
      ...
      <div class="slider-area">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center"data-background="assets/img/taxi/taxi1.jpg" >
                <div class="container">
                    <div class="row ">
                        <div class="col-md-11 offset-xl-1 offset-lg-1 offset-md-1">
                            <div class="hero-caption">
                            <a href="ongoingres.php"><span>Reserve</span>
                                <h2>Your Taxi</h2></a>
        ...
        <!-- slider Area End-->
          ...
          <!-- Taxi Start -->
          <section class="taxi-area r-padding1">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <div class="font-back-tittle mb-45">
                            ...
                            <h3 class="archivment-back">Our Vehicles</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <!-- Car Taxi -->
                        <div class="car-taxi mb-50">
                            <div class="taxi-img">
                               <a href="taxi.php"><img src="assets/img/taxi/taxi4.jpg" alt=""></a>
                            </div>
                            <div class="taxi-caption">
                                <h3><a href="taxi.php">Car</a></h3>
                                <div class="per-1Km">
                                    <span><u>LKR </u>50 <span>/ per 1Km</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="car-taxi mb-50">
                            <div class="taxi-img">
                               <a href="taxi.php"><img src="assets/img/taxi/taxi2.jpg" alt=""></a>
                            </div>
                            <div class="taxi-caption">
                                <h3><a href="taxi.php">Van</a></h3>
                                <div class="per-1Km">
                                    <span><u>LKR </u>40 <span>/ per 1Km</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="car-taxi mb-50">
                            <div class="taxi-img">
                               <a href="taxi.php"> <img src="assets/img/taxi/taxi3.jpg" alt=""></a>
                            </div>
                            <div class="taxi-caption">
                                <h3><a href="taxi.php">Budget Car</a></h3>
                                <div class="per-1Km">
                                    <span><u>LKR </u>30 <span>/ per 1Km</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
