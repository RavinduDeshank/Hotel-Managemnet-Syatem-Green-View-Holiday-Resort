<?php
include 'Backend/registeradmin.inc.php';
?>
<!doctype html>
...
<body>
    ...
    <div class="register">
        ...
        <form action="" method="POST" id="form">
            ...
            <input type="submit" value="Submit" id="sub2" name="signup">
            <a href="admin.php"><button type="button" value="reset" id="reset3"> Panel </button></a>
