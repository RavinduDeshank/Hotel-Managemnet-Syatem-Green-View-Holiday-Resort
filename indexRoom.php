...
<title>Room Finance Details</title>
...
<div class = "wrapper">
    ...
    <img class = "imge" src = "assets/img/logo/logo-img.png">
        ...
        <!--link all pages-->
            ...
            <li class = "active"><a href = "indexRoom.php"><i class="fas fa-bed"></i>Room</a></li>
    ...
    <div class="main_content">
        <div class = "header">Overview of Room Finance Management</div>

        <?php require_once 'Backend/roomIndex.php'; ?>
        ...
        <?php
            ...
            $result = $mysqli->query("SELECT * FROM room_payment") or die($mysqli->error);
        ?>
        <!--create table in application to show inserted data-->
            ...
            <div class = "tab">
                <table class="table">
                    ...
                    <?php
                    //add row with edit and delete button
                        while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href = "indexRoom.php?edit=<?php echo $row['customer_id']; ?>"
                                    class = "btn btn-info">Edit</a>
                                    <a href = "indexRoom.php?delete=<?php echo $row['customer_id']; ?>"
            ...
            <!--create form to insert data to room_payment table-->
            <div class = "row justify-content-center">
                <div class = "info">
                    <form action="" method = "POST">
                        ...
                        <div class="form-group">
                            ...
                            class = "form-control" placeholder = "Payment" pattern = "[^ @]*@[^ @]*" 
                        ...
                        <div class="form-group">
                            ...
                            if($update == true):
                            ?>
                            <!--if click the edit button show this update button-->
